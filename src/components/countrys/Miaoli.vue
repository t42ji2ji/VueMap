<template>
  <svg :width="svgWidth" :height="svgHeight" class="townSVG MiaoliSVG">
...
export default {
  ...
  mounted() {
    ...
    //   );
      var g = d3.selectAll(".MiaoliSVG");
    g.attr("transform", `translate(${this.scaleContry[".Miaoli"].offsetX},${this.scaleContry[".Miaoli"].offsetY})`)
    g.transition()
      .duration(900)
      .style("opacity", 1.0)
      .attr(
        ...
        "transform",
        `scale(${this.zoom[2] * this.scaleContry[".Miaoli"].scale}) translate(${this.zoom[0] + this.scaleContry[".Miaoli"].offsetX},${this.zoom[1] +this.scaleContry[".Miaoli"].offsetY})`
      );
  },
